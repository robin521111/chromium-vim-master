...
var defaultSettings = {
  ...
  GISTURL: '',
  FUNCTIONS: {},
  COMMANDBARCSS: '#rVim-command-bar, #rVim-command-bar-mode, #rVim-command-bar-input, #rVim-command-bar-search-results,\n.rVim-completion-item, .rVim-completion-item .rVim-full, .rVim-completion-item .rVim-left,\n.rVim-completion-item .rVim-right {\n  font-family: Helvetica, Helvetica Neue, Neue, sans-serif, monospace, Arial;\n  font-size: 10pt !important;\n  -webkit-font-smoothing: antialiased !important;\n}\n\n#rVim-command-bar {\n  position: fixed;\n  z-index: 2147483646;\n  background-color: #1b1d1e;\n  color: #bbb;\n  display: none;\n  box-sizing: content-box;\n  box-shadow: 0 3px 3px rgba(0,0,0,0.4);\n  left: 0;\n  width: 100%;\n  height: 20px;\n}\n\n#rVim-command-bar-mode {\n  display: inline-block;\n  vertical-align: middle;\n  box-sizing: border-box;\n  padding-left: 2px;\n  height: 100%;\n  width: 10px;\n  padding-top: 2px;\n  color: #888;\n}\n\n#rVim-command-bar-input {\n  background-color: #1b1d1e;\n  color: #bbb;\n  height: 100%;\n  right: 0;\n  top: 0;\n  width: calc(100% - 10px);\n  position: absolute;\n}\n\n#rVim-command-bar-search-results {\n  position: fixed;\n  width: 100%;\n  overflow: hidden;\n  z-index: 2147483647;\n  left: 0;\n  box-shadow: 0 3px 3px rgba(0,0,0,0.4);\n  background-color: #1c1c1c;\n}\n\n.rVim-completion-item, .rVim-completion-item .rVim-full, .rVim-completion-item .rVim-left, .rVim-completion-item .rVim-right {\n  text-overflow: ellipsis;\n  padding: 1px;\n  display: inline-block;\n  box-sizing: border-box;\n  vertical-align: middle;\n  overflow: hidden;\n  white-space: nowrap;\n}\n\n.rVim-completion-item:nth-child(even) {\n  background-color: #1f1f1f;\n}\n\n.rVim-completion-item {\n  width: 100%; left: 0;\n  color: #bcbcbc;\n}\n\n.rVim-completion-item[active] {\n  width: 100%; left: 0;\n  color: #1b1d1e;\n  background-color: #f1f1f1;\n}\n\n.rVim-completion-item[active] span {\n  color: #1b1d1e;\n}\n\n.rVim-completion-item .rVim-left {\n  color: #fff;\n  width: 37%;\n}\n\n.rVim-completion-item .rVim-right {\n  font-style: italic;\n  color: #888;\n  width: 57%;\n}\n\n\n#rVim-link-container, .rVim-link-hint,\n#rVim-hud, #rVim-status-bar {\n  font-family: Helvetica, Helvetica Neue, Neue, sans-serif, monospace, Arial;\n  font-size: 10pt !important;\n  -webkit-font-smoothing: antialiased !important;\n}\n\n#rVim-link-container {\n  position: absolute;\n  pointer-events: none;\n  width: 100%; left: 0;\n  height: 100%; top: 0;\n  z-index: 2147483647;\n}\n\n.rVim-link-hint {\n  position: absolute;\n  color: #302505 !important;\n  background-color: #ffd76e !important;\n  border-radius: 2px !important;\n  padding: 2px !important;\n  font-size: 8pt !important;\n  font-weight: 500 !important;\n  text-transform: uppercase !important;\n  border: 1px solid #ad810c;\n  display: inline-block !important;\n  vertical-align: middle !important;\n  text-align: center !important;\n  box-shadow: 2px 2px 1px rgba(0,0,0,0.25) !important;\n}\n\n.rVim-link-hint_match {\n  color: #777;\n  text-transform: uppercase !important;\n}\n\n\n#rVim-hud {\n  background-color: rgba(28,28,28,0.9);\n  position: fixed !important;\n  transition: right 0.2s ease-out;\n  z-index: 24724289;\n}\n\n#rVim-hud span {\n  padding: 2px;\n  padding-left: 4px;\n  padding-right: 4px;\n  color: #8f8f8f;\n  font-size: 10pt;\n}\n\n#rVim-frames-outline {\n  position: fixed;\n  width: 100%;\n  height: 100%;\n  left: 0;\n  top: 0;\n  right: 0;\n  z-index: 9999999999;\n  box-sizing: border-box;\n  border: 3px solid yellow;\n}\n'
};
...
Options.fetchGist = function() {
  httpRequest({
    ...
    try {
      ...
      console.error('rVim Error: error parsing config file');
    }
    ...
    if (updated.autoupdategist) {
      self.setTimeout(Options.fetchGist, 1000 * 60 * 60);
    }
  });
};
